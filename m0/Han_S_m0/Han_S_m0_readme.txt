...
2. Three special items and effects
   ...
   2.1 SizeUp
      ...
      ·Observation: Roll the ball into the mushroom, and the ball becomes 1.5x size for 10 seconds.
   ...
   2.2 SpeedUp
      ...
      ·Implementation(PlayerController.cs:135-140; Floater.cs): The player's speed is multiplied by 2. After waiting for 10 seconds, the original speed is restored. The SpeedUp item also uses the floater script to create a floating animation. It is implemented by continuously modifying the y position as a time-dependent sine function.
